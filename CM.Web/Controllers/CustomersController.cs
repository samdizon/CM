...
namespace CM.Web.Controllers
{
    public class CustomersController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Customer.Include(c => c.Department);
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Gender,DepartmentId")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Gender,DepartmentId")] Customer customer)
        {
            if (id != customer.Id)
            {
                return NotFound();
